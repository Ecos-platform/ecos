...
struct real_action : action
{
    ...
    {
        sim.get_real_property(id)->set_value(value);
    }
};
...
struct bool_action : action
{
    ...
    void apply(simulation& sim) override
    {
        sim.get_bool_property(id)->set_value(value);
    }
};
...
struct int_action : action
{
    ...
    void apply(simulation& sim) override
    {
        sim.get_int_property(id)->set_value(value);
    }
};
...
struct string_action : action
{
    ...
    void apply(simulation& sim) override
    {
        sim.get_string_property(id)->set_value(value);
    }
};
